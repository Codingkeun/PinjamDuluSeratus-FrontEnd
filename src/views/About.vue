    ...
    <div class="about-page-area d-flex flex-column mt-5 mb-5" style="padding-inline: calc(15% / 2); gap: clamp(3rem, calc(1vw + 4rem), 5rem)">
        <div class="row d-flex align-items-center" style="gap: clamp(1rem, calc(1vw + 4rem), 3rem)">
            ...
            <p class="col-md-6">
                ...
                <br><br>
                Tujuan utama dari website ini adalah membantu mahasiswa mendapatkan akses ke dana darurat <span class="text-primary font-weight-semibold">tanpa risiko terlilit dalam utang bunga tinggi</span>, menjadikannya alternatif yang lebih berkelanjutan dan etis.
            </p>
        </div>
        <div>
            <div class="mb-5">
