...
<main class="mt-5 mb-5" style="padding-inline: calc(15% / 2);">
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap mt-5 mb-4" style="gap: 2rem;">
        ...
        <router-link to="/history-payment" class="btn btn-border bg-white text-primary font-weight-semibold" style="height: 44px; border: 2px solid var(--primary);" v-if="detail.status_aproval == 'approve'">Lihat Histori Pembayaran</router-link>
    </div>
    <div class="alert alert-info rounded-10 d-flex">
