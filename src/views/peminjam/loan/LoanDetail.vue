...
<main class="mt-5 mb-5" style="padding-inline: calc(15% / 2);">
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap mt-5 mb-4" style="gap: 2rem;">
        ...
        <button @click="$router.push(`/history-payment/` + $route.params.id)" class="btn btn-border bg-white text-primary font-weight-semibold" style="height: 44px; border: 2px solid var(--primary);" v-if="detail.status_approval == 'approve'">Lihat Histori Pembayaran</button>
    </div>
